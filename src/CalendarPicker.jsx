      ...
      {isOpen && (
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            <button type="button" onClick={prevMonth} style={{ background: 'none', border: '1px solid #cbd5e0', borderRadius: '6px', padding: '0.3rem 0.6rem', cursor: 'pointer', fontWeight: 'bold' }}>&lt;</button>
            <span style={{ fontWeight: 'bold', color: '#2d3748' }}>{monthNames[month]} {year}</span>
            <button type="button" onClick={nextMonth} style={{ background: 'none', border: '1px solid #cbd5e0', borderRadius: '6px', padding: '0.3rem 0.6rem', cursor: 'pointer', fontWeight: 'bold' }}>&gt;</button>
          </div>
